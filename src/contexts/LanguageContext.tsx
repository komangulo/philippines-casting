...
const translations: Record<string, { en: string; th: string }> = {
  'applyNow': {
    en: 'Apply Now Philippines porn Audition',
    th: 'Mag-apply na Philippines porn Audition'
  },
  'successStories': {
  ...
  'mainTitle': {
    en: 'PHILIPPINES CASTING PORN AUDITION',
    th: 'Paghahagilap ng Artista sa Pelikulang Pang-may Gulang, Pilipinas'
  },
  'mainSubtitle': {
    en: 'Start your career in the Philippines\' adult entertainment industry today',
    th: 'Simulan ang iyong karera sa industriya ng libangan para sa mga nasa hustong gulang ng Pilipinas ngayon'
  },
  'faqQuestion1': {
  ...
  'faqQuestion5': {
    en: 'Is it safe to work in the adult industry in the Philippines?',
    th: 'Ligtas bang magtrabaho sa industriya ng pang-adulto sa Pilipinas?'
  },
  'faqAnswer5': {
  ...
  'faqQuestion6': {
    en: 'What is the lifestyle like as an adult performer in the Philippines?',
    th: 'Ano ang lifestyle bilang isang adult performer sa Pilipinas?'
  },
  'faqAnswer6': {
    en: 'Working in the Philippines\' adult entertainment industry offers an exciting and unique lifestyle. Many of our talents enjoy flexible schedules that allow them to explore the Philippines\' beautiful beaches, vibrant cities, and rich culture during their free time. You\'ll be part of an international community of like-minded professionals. The work can be demanding but also incredibly rewarding both personally and financially.',
    th: 'Ang pagtatrabaho sa industriya ng libangan para sa mga nasa hustong gulang ng Pilipinas ay nag-aalok ng isang kapanapanabik at natatanging lifestyle. Marami sa aming mga talento ang nasisiyahan sa mga flexible na iskedyul na nagbibigay-daan sa kanila na tuklasin ang magagandang beach, masiglang lungsod, at mayamang kultura ng Pilipinas sa kanilang libreng oras. Magiging bahagi ka ng isang internasyonal na komunidad ng mga propesyonal na may parehong interes. Ang trabaho ay maaaring maging mapaghamon ngunit lubos na kapaki-pakinabang kapwa sa personal at pinansyal.'
  },
  'faqQuestion7': {
  ...
  'faqAnswer8': {
    en: 'It\'s simple! All you need to do is reach out to us. We will guide you through the process, answer all your questions, and connect you with the best opportunities in the Philippines. Your dream career is just a message away. Contact us now to take the first step!',
    th: 'ง่ายมาก! สิ่งที่คุณต้องทำคือติดต่อเรา เราจะแนะนำคุณตลอดกระบวนการ ตอบทุกคำถามของคุณ และเชื่อมต่อคุณกับโอกาสที่ดีที่สุดใน Pilipinas อาชีพในฝันของคุณอยู่ใกล้แค่การส่งข้อความ ติดต่อเราตอนนี้เพื่อเริ่มต้นขั้นตอนแรก!'
  },
  'welcomeText': {
    en: 'Welcome to the Philippines\' premier adult entertainment casting platform! Are you looking for an exciting new opportunity in the Philippines\' adult industry? We connect talented individuals with top production companies and agencies across the Philippines. Whether you\'re experienced or new to the industry, our platform provides everything you need to start your career. Begin your journey with us today!',
    th: 'Maligayang pagdating sa nangungunang platform ng paghahagilap ng libangan para sa mga nasa hustong gulang ng Pilipinas! Naghahanap ka ba ng isang kapana-panabik na bagong oportunidad sa industriya ng pang-adulto ng Pilipinas? Ikinokonekta namin ang mga talentadong indibidwal sa mga nangungunang kumpanya ng produksyon at ahensya sa buong Pilipinas. May karanasan ka man o baguhan sa industriya, ang aming platform ay nagbibigay ng lahat ng kailangan mo upang simulan ang iyong karera. Simulan ang iyong paglalakbay kasama namin ngayon!'
  },
  'findYourPerfectJob': {
  ...
  'dontWait': {
    en: "Don't Wait, Your Opportunity in the Philippines' Adult Industry is Here! Philippines Casting Porn Audition",
    th: 'Huwag nang maghintay, narito na ang iyong pagkakataon sa industriya ng pang-adulto ng Pilipinas! Philippines Casting Porn Audition'
  },
  'browseListings': {
    en: 'Browse our latest opportunities and take the first step toward a new, exciting career in the Philippines\' adult entertainment industry.',
    th: 'Tingnan ang aming pinakabagong mga pagkakataon at gawin ang unang hakbang patungo sa isang bago at kapanapanabik na karera sa industriya ng libangan para sa mga nasa hustong gulang sa Pilipinas.'
  },
  'nowHiring': {
    en: 'Now Casting: Top Production Companies Are Looking for New Talent! • Ready to Begin? Start Your Career in Philippines\' Adult Industry',
    th: 'Ngayon ay naghahagilap: Ang mga nangungunang kumpanya ng produksyon ay naghahanap ng bagong talento! • Handa nang Magsimula? Simulan ang Iyong Karera sa Industriya ng Pang-adulto ng Pilipinas'
  },
  'nokReview': {
    en: 'Working in the adult industry has completely transformed my life. The financial freedom is incredible - I can support my family back in the province and still have plenty left for myself. The team has been incredibly supportive, making sure I feel safe and respected at all times. This opportunity has given me confidence I never knew I had!',
    th: 'Ang pagtatrabaho sa industriya ng pang-adulto ay lubos na nagbago sa aking buhay. Ang kalayaang pinansyal ay hindi kapani-paniwala - kaya kong suportahan ang aking pamilya sa probinsiya at mayroon pa ring natitira para sa aking sarili. Ang koponan ay lubos na sumusuporta, tinitiyak na ligtas at iginagalang ako sa lahat ng oras. Ang oportunidad na ito ay nagbigay sa akin ng kumpiyansa na hindi ko alam na mayroon pala ako!'
  },
  'daoName': {
    en: 'Maria',
    th: 'มาเรีย'
  ...
  'yingLocation': {
    ...
    th: 'Lungsod ng Iloilo, Kabisayaan'
  },
  'googleReview': {
    en: 'Google Review',
    th: 'รีวิวจาก Google'
